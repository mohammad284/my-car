					...
					<div class="row align-items-center">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-6">
							<div class="brand_logo">
								<a href="/">
									<img style="max-width: 100%; max-height: 75px;" src="front_end/assets/images/white_logo_1.png" srcset="front_end/assets/images/white_logo_1.png 2x" alt="logo_not_found">
				...
				<div class="mobile_sidebar_menu">
					...
					<div class="about_content mb_60">
						<div class="brand_logo mb_15">
							<a href="/">
								<img src="front_end/assets/images/white_logo_1.png" srcset="front_end/assets/images/white_logo_1.png 2x" alt="logo_not_found">
							</a>
						</div>
						<p class="mb-0">
