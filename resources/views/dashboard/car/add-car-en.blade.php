          ...
          @endif
            ...
            <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <select class="form-select" name="name_ar" id="name_ar" >
        ...
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                  <label for="exampleFormControlSelect1" class="form-label">{{__('ماركة السيارة')}}</label>
                  <select class="form-select" name="name_ar" id="exampleFormControlSelect1" >
              ...
              <label class="form-label"> {{__('لون السيارة')}} </label>
                <div id="cp1" class="input-group mb-2" title="Using input value">
                  <input type="text" class="form-control" name="color" value="#DD0F20FF" disabled />
