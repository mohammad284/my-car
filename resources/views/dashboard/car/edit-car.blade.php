...
@section('content')
<h4 id="default">{{__('تعديل السيارة')}}</h4>
    <div class="example">
      ...
      <div class="tab-content border border-top-0 p-3" id="myTabContent">
        ...
        <form class="forms-sample"  method="POST" enctype="multipart/form-data" action="/admin/updateCar/{{$car_ar->id}}">@else
        <form class="forms-sample"  method="POST" enctype="multipart/form-data" action="/provider/updateCar/{{$car_ar->id}}">@endif
            @csrf
            <div class="row mb-6">
              <div class="col-md-6">
                <div class="mb-3">
            ...
            <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input class="form-control mb-4 mb-md-0" value="{{$car_ar->number_of_car}}" name="number_of_car_ar" required/>
              </div>
              <div >
                <br>
              </div>
              <div class="col-md-6">
                ...
                <textarea  class="form-control" id="text" name="specification_ar" required>{{$car_ar->specification}}</textarea>
              </div>
              <div class="col-md-6">
                <label class="form-label">{{__('معلومات هامة')}}</label>
                <textarea  class="form-control" id="text" name="important_information_ar" required>{{$car_ar->important_information}}</textarea>
              </div>
              <div >
                <br>
              </div>
              ...
              <div class="col-md-6">
                ...
                <input class="form-control mb-4 mb-md-0" value="{{$car_ar->manufacturing}}" name="manufacturing" required/>
              </div>
              <div class="col-md-6">
                <label class="form-label"> {{__('مبلغ التأمين')}}</label>
                <input class="form-control mb-4 mb-md-0" value="{{$car_ar->security_deposit}}" name="security_deposit" required/>
              </div>
              <div >
                <br>
              </div>
              <div class="col-md-6">
                ...
                <input class="form-control mb-4 mb-md-0" value="{{$car_ar->fuel_policy}}"  name="fuel_policy_ar" required/>
              </div>

              <div class="col-md-6">
                <label class="form-label"> {{__('عدد الكيلومترات')}}  </label>
                <input class="form-control mb-4 mb-md-0" value="{{$car_ar->mileage}}" name="mileage" required/>
              </div>
              <div >
                <br>
              </div>
              <div class="col-md-6">
                ...
                <textarea  class="form-control" id="text" name="extra_information_ar" required>{{$car_ar->extra_information}}</textarea>
              </div>

              <div class="col-md-6">
                <div class="mb-3">
                  <label for="exampleInputNumber1" class="form-label">{{__('عدد المقاعد')}}</label>
                  <input type="number" class="form-control" name="site" min="1" id="exampleInputNumber1" value="{{$car_ar->site}}" required>
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                    <label for="exampleInputNumber1" class="form-label">{{__('عدد الابواب')}}</label>
                    <input type="number" class="form-control" name="door" min="1"  id="exampleInputNumber1" value="{{$car_ar->door}}" required>
                </div>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input class="form-control mb-4 mb-md-0" value="{{$car_ar->damage_excess}}" name="damage_excess_ar" required/>
                </div>
              </div>
              <div class="col-md-6">
                <label class="form-label"> {{__('السعر ليوم واحد')}}</label>
                <input class="form-control mb-4 mb-md-0" value="{{$car_ar->price_for_day}}" name="price_for_day" required/>
              </div>
              <div >
                <br>
              </div>
              <div class="col-md-6">
                ...
                <input class="form-control mb-4 mb-md-0" name="weekly_price" value="{{$car_ar->weekly_price}}" required/>
              </div>

              <div class="col-md-6">
                <label class="form-label"> {{__('السعر لمدة شهر')}}  </label>
                <input class="form-control mb-4 mb-md-0" name="monthly_price" value="{{$car_ar->monthly_price}}" required />
              </div>
              <div class="col-md-6">
                <div class="mb-3">
              ...
              <div class="col-md-6">
                ...
                <div class="mb-3">
                  <div class="form-check form-check-inline">
                    <input type="radio" class="form-check-input" value="1" name="automatic" id="radioInline"  @if($car_ar->automatic ==1) checked @endif required>
                    <label class="form-check-label" for="radioInline">
          {{__('أتوماتيكي')}}                     
                    </label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input type="radio" class="form-check-input" value="0" name="automatic" id="radioInline" @if($car_ar->automatic ==0) checked @endif required>
                    <label class="form-check-label" for="radioInline">
                      {{__('يدوي')}}                    
                    </label>
                  </div>
        ...
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            ...
            <div class="col-md-6">
              ...
              <div class="col-md-6">
                <label class="form-label">{{__('رقم السيارة')}}</label>
                <input class="form-control mb-4 mb-md-0" value="{{$car_en->number_of_car}}" name="number_of_car_en" required/>
              </div>
              <div >
                <br>
              </div>
              ...
              <div class="col-md-6">
              <label class="form-label">{{__('المواصفات')}}</label>
                <textarea  class="form-control" id="text"  name="specification_en" required>{{$car_en->specification}}</textarea>
              </div>
              <div class="col-md-6">
                <label class="form-label">{{__('معلومات هامة')}}</label>
                <textarea  class="form-control" id="text"  name="important_information_en" required>{{$car_en->important_information}}</textarea>
              </div>
              <div >
                <br>
              </div>
              ...
              <div class="col-md-6">
                <label class="form-label"> {{__('مبلغ التأمين')}}</label>
                <input class="form-control mb-4 mb-md-0" value="{{$car_en->security_deposit}}" name="security_deposit" disabled />
              </div>
              <div >
                <br>
              </div>
              <div class="col-md-6">
                <label class="form-label"> {{__('مستوى الوقود')}} </label>
                <input class="form-control mb-4 mb-md-0" value="{{$car_en->fuel_policy}}" name="fuel_policy_en" required/>
              </div>

              <div class="col-md-6">
                <label class="form-label"> {{__('عدد الكيلومترات')}}  </label>
                <input class="form-control mb-4 mb-md-0" value="{{$car_en->mileage}}" name="mileage" disabled />
              </div>
              <div >
                <br>
              </div>
              <div class="col-md-6">
                <label class="form-label"> {{__('معلومات اضافية')}}  </label>
                <textarea  class="form-control" id="text" value="{{$car_en->extra_information}}" name="extra_information_en" required></textarea>
              </div>

              <div class="col-md-6">
                <div class="mb-3">
                <label for="exampleInputNumber1" class="form-label">{{__('عدد المقاعد')}}</label>
                  <input type="number" class="form-control" name="site" min="1" id="exampleInputNumber1" value="{{$car_en->site}}" disabled >
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                <label for="exampleInputNumber1" class="form-label">{{__('عدد الابواب')}}</label>
                    <input type="number" class="form-control" name="door" min="1"  id="exampleInputNumber1"value="{{$car_en->door}}" disabled >
                </div>
              </div>
              <div class="col-md-6">
                <label class="form-label"> {{__('لون السيارة')}} </label>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                <label for="exampleInputNumber1" class="form-label">{{__('الضرر الزائد')}}</label>
                    <input class="form-control mb-4 mb-md-0" value="{{$car_en->damage_excess}}" name="damage_excess_en" required/>
                </div>
              </div>
              <div class="col-md-6">
              <label class="form-label"> {{__('السعر ليوم واحد')}}</label>
                <input class="form-control mb-4 mb-md-0" value="{{$car_en->price_for_day}}" name="price_for_day" disabled />
              </div>
              <div >
                <br>
              </div>
