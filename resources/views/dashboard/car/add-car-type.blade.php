...
@section('content')
<h4 id="default">{{__('إضافة نوع سيارة')}}</h4>
    <div class="example">
      ...
      <div class="tab-content border border-top-0 p-3" id="myTabContent">
        ...
        <form class="forms-sample"  method="POST" enctype="multipart/form-data" action="/admin/storeCarType">
            @csrf
            <div class="row mb-6">
            ...
            <div class="row mb-3">
                ...
                <input  class="form-control" id="text" name="type_ar" required></input>
                </div>
            </div>
            <div class="row">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            ...
            <div class="row mb-3">
                <div class="col">
                <label class="form-label"> {{__('الاسم')}}:</label>
                <input  class="form-control" id="text" name="type_en" required></input>
                </div>
            </div>
