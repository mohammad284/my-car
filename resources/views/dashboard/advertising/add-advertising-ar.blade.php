        ...
        <form class="forms-sample"  method="POST" enctype="multipart/form-data" action="/admin/storeAdvertising">
            ...
            <div class="row mb-6">
              <div class="col-md-6">
                ...
                <select class="js-example-basic-single form-select" id="bg_color" name="bg_color"  data-width="100%" required>
                  <option selected="" value="" disabled>{{__('الرجاء إختيار لون الخلفية مناسب للون السيارة')}}</option>
                  @foreach($colors as $color)
                      <option value='{{ $color->color }}'>{{$color->color_ar}}</option>
                    @endforeach 
                </select>
              </div>
              <div class="col-md-6">
                <label class="form-label"> {{__('لون الخط')}} </label>
                <select class="js-example-basic-single form-select" id="font_color" name="font_color"  data-width="100%" required>
              ...
              <div class="col-md-6">
                ...
                <select class="js-example-basic-single form-select" id="provider_car" name="provider_car"  data-width="100%" required>
              ...
              <div class="col-md-6">
                ...
                <select class="js-example-basic-single form-select" name="car_id" id="car_id"  data-width="100%" required>
