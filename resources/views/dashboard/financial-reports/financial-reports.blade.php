...
<h4 id="default">{{__('تقارير مالية')}}</h4>
    <p class="mb-3"> {{__('إحصائيات الأرباح')}}</p>
    <div class="row">
      <div class="col-md-12 grid-margin">
        <div class="card">
          <div class="card-body">
          <h6 class="card-title">{{__('تطبيق فلتر بحث')}}</h6>
            <form class="forms-sample"  method="POST" enctype="multipart/form-data" action="/admin/financialReportFilter">
              @csrf
              <div class="row mb-3">
                <div class="col-md-6">
            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                ...
                <table id="dataTableExample" class="table">
                  ...
                  <a type="button" href="/admin/printTodayFinancialReport" class="btn btn-outline-primary btn-icon-text me-2 mb-2 mb-md-0">
            ...
            <div class="table-responsive">
                <table id="dataTableExample" class="table">
                  ...
                  @foreach($commission_details as $details)
                        ...
                        <td class="action"> 
                            <a  title="{{__('تفاصيل السيارات')}}" href="/admin/autoDetailsweek/{{$details['provider']->id}}"> <i data-feather="eye"></i></i></a>
                        </td>
                        </tr>
                    @endforeach
                  </tbody>
            ...
            <div class="table-responsive">
                ...
                <table id="dataTableExample" class="table">
                  ...
                  @foreach($commission_details as $details)
                        ...
                        <td class="action"> 
                            <a  title="{{__('تفاصيل السيارات')}}" href="/admin/autoDetailsMonth/{{$details['provider']->id}}"> <i data-feather="eye"></i></i></a>
                        </td>
                        </tr>
                    @endforeach
                  </tbody>
